...
X_train = pd.read_csv('./s7/data/X_train.csv', parse_dates=['reportts'])
y_train = pd.read_csv('./s7/data/y_train.csv', parse_dates=['reportts'])
X_test = pd.read_csv('./s7/data/X_test.csv', parse_dates=['reportts'])
